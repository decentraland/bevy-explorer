...
use system_bridge::{settings::NewCameraEvent, FeatureFlagsConfig, NativeUi, SystemBridgePlugin};
...
fn main() {
    ...
    let disable_features: String = args
        .value_from_str("--disable-features")
        .unwrap_or_default();

...
//     --engine target/release/decentraland_headless_authoritative --sidecar target/release/dcl_deno_ipc \
...
for (const [src, name] of [
  [engine, `decentraland_headless_authoritative${exeSuffix}`],
...
fs.writeFileSync(
  ...
  `# @dcl-regenesislabs/bevy-headless-server-${platform}\n\n` +
    ...
    `\`decentraland_headless_authoritative\` and \`dcl_deno_ipc\` must stay in the same directory — the engine execs the\n` +

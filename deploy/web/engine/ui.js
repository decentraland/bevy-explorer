...
// The UI/bridge scene ships INSIDE this web bundle at ../bridge-scene/static (generated by
// `react-web/bridge-scene/npm run bundle`). Resolve it RELATIVE to this page — the package is
// served from a versioned CDN subpath (cdn.decentraland.org/<pkg>/<version>/engine/), so an
// origin-absolute path would 404. (Override via the ?systemScene= URL param.)
const DEFAULT_SYSTEMSCENE = new URL("../bridge-scene/static/BevyExplorerUI", window.location.href).href;

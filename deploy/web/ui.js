...
// `react-web/bridge-scene/npm run bundle`). Resolve it same-origin so it works wherever this
// package is served — no external host. (Override via the ?systemScene= URL param.)
const DEFAULT_SYSTEMSCENE = window.location.origin + "/bridge-scene/static/BevyExplorerUI";
